...
export const hexStringToBytes = (hexString) => {
    var _a, _b;
    return new Uint8Array((_b = (_a = hexString.replace(/[^0-9a-f]/ig, '').match(/[0-9a-f]{1,2}/ig)) === null || _a === void 0 ? void 0 : _a.map(hexToByte)) !== null && _b !== void 0 ? _b : []);
};
export const bytesToHexArray = (bufferSource) => Array.from(bs2u8(bufferSource), byte => byteToHex(byte));
export const bytesToHexString = (bufferSource) => bytesToHexArray(bufferSource).join('');
// Concatenation
// -------------
